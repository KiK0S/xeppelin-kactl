...
\section{Math}
	...
	\subsection{Karp's algorithm}
		Min mean weight cycle: find $\max_v \min_k \frac{dist_{n}(v) - dist_{k}(v)}{n-k}$ for a fixed start point.